...
var EnrolamientoComponent = (function () {
    ...
    EnrolamientoComponent.prototype.ngOnInit = function () {
        ...
        this.enrolFrom.get('nombre').valueChanges.subscribe(function (value) {
            _this.personEnrolar.nombre = value.toUpperCase();
            _this.qrModelChange();
        });
        this.enrolFrom.get('apellidoPaterno').valueChanges.subscribe(function (value) {
            _this.personEnrolar.apellidoPaterno = value.toUpperCase();
            _this.qrModelChange();
        });
        this.enrolFrom.get('rfc').valueChanges.subscribe(function (value) {
            _this.personEnrolar.rfc = value.toUpperCase();
            _this.qrModelChange();
        });
    ...
    EnrolamientoComponent.prototype.uploadEnrolImage = function () {
        ...
        this.uploadBusy = this._prestoService.makeFileRequest(__WEBPACK_IMPORTED_MODULE_3__common_global__["a" /* GLOBAL */].RESTAPINJS + 'saveEnrolImage/' + this.personEnrolar._id + '/' + oldImageFile, [], this.filesToUpload, 'image')
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_busy__ = __webpack_require__("../../../../angular2-busy/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_busy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_angular2_busy__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
EnrolamientoModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8_angular2_busy__["BusyModule"]
        ],
        declarations: [
