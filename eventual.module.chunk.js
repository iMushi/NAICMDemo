...
var EventualComponent = (function () {
    ...
    EventualComponent.prototype.guardar = function () {
        ...
        this._prestoService.saveEventual(eventual).toPromise().then(function (resp) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* ViewChild */])('imgEventual'),
